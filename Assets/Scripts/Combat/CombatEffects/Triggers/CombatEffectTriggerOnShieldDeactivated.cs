...
public class CombatEffectTriggerOnShieldDeactivated : CombatEffectTrigger
{
    private Ship m_ship;
    ...
    private void RegisterInternal()
    {
        if (m_ship != null
            && m_ship.Context != null)
        {
            m_ship.Context.OnShipShieldDeactivated += OnShipShieldDeactivated;
        }
    }
    ...
    private void OnShipShieldDeactivated(ShipContext a_context)
    {
